...
const yy: [number, number] = [32, 31]; // On peut simplifier cela en enlevant : [number, number]
...
//contactInfo.phone; // 🚨 ERROR : Property 'phone' does not exist on type 'HasPhoneNumber | HasEmail'. Property 'phone' does not exist on type 'HasEmail'.
/**
